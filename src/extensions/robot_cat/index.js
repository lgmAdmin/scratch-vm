...
class RobotCat {
  ...
  getInfo() {
    ...
    return {
      ...
      name: formatMessage({
                id: 'robotcat.name',
                default: 'Cat face recognition',
                description: 'robotcat.name'
            }),
      color1: '#b22222',
      menuIconURI: imgIcon,
      ...
      blocks: [
...

        {
            ...
            text: formatMessage({
                id: 'robotcat.catNum',
                default: 'Number of cat faces detected',
                description: 'robotcat.catNum'
            }),
            arguments:{
...

        {
            ...
            // text: '获取猫脸位置信息[ONE]',
            text: formatMessage({
                id: 'robotcat.catPlace',
                default: 'Get cat face position [ONE]',
                description: 'robotcat.catPlace'
            }),
            arguments:{
                ONE:{
