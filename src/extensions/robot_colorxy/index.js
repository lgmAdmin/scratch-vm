...
class RobotColorxy {
  ...
  getInfo() {
    ...
    return {
      id: 'robotcolorxy',
      name: formatMessage({
            id: 'robotcolorxy.name',
            default: 'Color Coordinate Tracking',
            description: 'robotcolorxy.name'
        }),
      color1: '#b22222',
      menuIconURI: imgIcon,
      ...
      blocks: [
...

        {
            ...
            // text: '设置追踪颜色[ONE]',
            text: formatMessage({
                id: 'robotcolorxy.setColor',
                default: 'Set tracking color [ONE]',
                description: 'robotcolorxy.setColor'
            }),
            arguments:{
                ONE:{
...

        {
            ...
            // text: '追踪到目标颜色？',
            text: formatMessage({
                id: 'robotcolorxy.isReadColor',
                default: 'Target color tracked?',
                description: 'robotcolorxy.isReadColor'
            }),
            arguments:{
...

        {
            ...
            // text: '获取色块位置信息[ONE]',
            text: formatMessage({
                id: 'robotcolorxy.readColorPlace',
                default: 'Get color block position [ONE]',
                description: 'robotcolorxy.readColorPlace'
            }),
            arguments:{
                ONE:{
                    type:ArgumentType.STRING,
...

        {
            ...
            // text: '获取色块的[ONE]',
            text: formatMessage({
                id: 'robotcolorxy.getColorWh',
                default: 'Get color block [ONE]',
                description: 'robotcolorxy.getColorWh'
            }),
            arguments:{
                ONE:{
    ...
    showToast(message, duration = 3000) {
        ...
        if(message == "请先开启摄像头"){
            ...
            toast.textContent = formatMessage({
                id: 'robotcolorxy.showToast.firstMode',
                default: 'Color tracking mode is not enabled',
                description: 'robotcolorxy.showToast.firstMode'
            })
        }
    ...
    async cstartMode(args){
       ...
       if(!imageLoad.getColorDete()){
            if(imageLoad.getCameraPlace()=='0'){
                ...
                await new Promise(resolve => setTimeout(resolve, 1000));
                imageLoad.getCamObj().startWColorBlockDetection()
            }
    ...
    async cstopMode(args){
        if(this.mode){
            if(imageLoad.getColorDete()){
                ...
                imageLoad.getCamObj().stopWColorBlockDetection()
