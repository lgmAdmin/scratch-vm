...
class RobotQr {
  ...
  getInfo() {
    ...
    return {
      ...
      blocks: [
...

        {
            ...
            text: formatMessage({
                id: 'robotqr.isQr',
                default: 'QR code detected?',
                description: 'robotqr.isQr'
            }),
            arguments:{
...

        {
            ...
            // text: '获取二维码内容',
            text: formatMessage({
                id: 'robotqr.getQrContent',
                default: 'Get QR code content',
                description: 'robotqr.getQrContent'
            }),
            arguments:{
...

        {
            ...
            // text: '获取二维码[ONE]轴信息',
            text: formatMessage({
                id: 'robotqr.getQrPlace',
                default: 'Get QR code [ONE] axis info',
                description: 'robotqr.getQrPlace'
            }),
            arguments:{
                ONE:{
...

        {
            ...
            text: formatMessage({
                id: 'robotqr.getQrWh',
                default: 'Get QR code [ONE]',
                description: 'robotqr.getQrWh'
            }),
            arguments:{
                ONE:{
    ...
    showToast(message, duration = 3000) {
        ...
        }else if(message == "未开启二维码识别模式"){
            toast.textContent = formatMessage({
                id: 'robotqr.showToast.firstMode',
                default: 'QR code recognition mode is not enabled',
                description: 'robotqr.showToast.firstMode'
            })
        }
        ...
        await new Promise(resolve => setTimeout(resolve, 200));
         ...
         if(!imageLoad.getQr()){
            if(imageLoad.getCameraPlace()=='0'){
                ...
                await new Promise(resolve => setTimeout(resolve, 1000));
                // imageLoad.getCamObj().setQRDetectedCallback((result) => {
                //     if (result) {
                ...
                //     }
                // });
                imageLoad.getCamObj().startQRDetection();
            }
            await new Promise(resolve => setTimeout(resolve, 1000)); 
            // this.runtime.ioDevices.video.startQRDetection()
    ...
    async cstopMode(args){
        if(this.mode){
            if(imageLoad.getQr()){
                ...
                imageLoad.getCamObj().stopQRDetection()
