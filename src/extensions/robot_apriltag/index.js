...
class RobotApriltag {
  ...
  getInfo() {
    ...
    return {
      id: 'robotapriltag',
      name: formatMessage({
            id: 'robotapriltag.name',
            default: 'AprilTag Detection',
            description: 'robotapriltag.name'
        }),
      color1: '#b22222',
      menuIconURI: imgIcon,
    ...
    showToast(message, duration = 3000) {
        ...
        if(message == "请先开启摄像头"){
            ...
            toast.textContent = formatMessage({
                id: 'robotapriltag.showToast.firstMode',
                default: 'AprilTag recognition mode is not enabled',
                description: 'robotapriltag.showToast.firstMode'
            })
        }
    ...
    async cstopMode(args){
        if(this.mode){
            ...
            if(imageLoad.getAprilTag()){
                ...
                imageLoad.getCamObj().stopAprilTag()
    ...
    isApril(){
       if(this.mode){
         if(!imageLoad.getAprilTag()){
            this.showToast("未开启AprilTag识别模式");
            this.runtime.stopAll();
            return 
        }
